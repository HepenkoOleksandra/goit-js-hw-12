...
`);s.galleryList.insertAdjacentHTML("beforeend",e),k.refresh()}async function g(){const a="https://pixabay.com/api/";return(await b.get(a,{params:{key:"42112521-3ff4dfc201bab0977369cd2bc",q:i,image_type:"photo",orientation:"horizontal",safesearch:"true",page:c,per_page:p}})).data}function q(){const e=document.querySelector(".gallery-item").getBoundingClientRect().height;window.scrollBy({top:e*2,behavior:"smooth"})}function m(){s.loadElem.classList.remove("hidden"),s.btnLoadMore.classList.add("hidden")}function h(){s.loadElem.classList.add("hidden"),s.btnLoadMore.classList.remove("hidden")}function v(){d.show({message:"Please enter a search query name!",messageColor:"white",backgroundColor:"red",position:"topRight"})}function S(){d.show({message:"Please enter a search query name!",messageColor:"white",backgroundColor:"red",position:"topRight"})}function M(){d.show({message:"We're sorry, but you've reached the end of search results.",messageColor:"white",backgroundColor:"red",position:"topRight"})}function f(){Math.ceil(y/p)<=c?(s.btnLoadMore.classList.add("hidden"),M()):s.btnLoadMore.classList.remove("hidden")}let k=new w(".gallery-link",{captionsData:"alt",captionDelay:500}),c=1;const p=15;let i="",y=0;s.form.addEventListener("submit",E);s.btnLoadMore.addEventListener("click",C);async function E(o){if(o.preventDefault(),c=1,i=o.target.elements.query.value.trim(),i===""){v();return}s.galleryList.innerHTML="",m();try{const e=await g();y=e.totalHits,e.hits.length===0?(S(),s.btnLoadMore.classList.add("hidden")):(u(e),f())}catch(e){console.log(e)}h(),o.target.reset()}async function C(o){o.preventDefault(),c+=1,m();try{const e=await g(i);u(e),h(),f()}catch(e){console.log(e.message)}q()}
